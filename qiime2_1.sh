...
# Microbiome cor diversity analysis---------------------------------------------------------------------------------------------------------------------------
...
#
#this is a  example of alpha deiversity  diff analysis---------------------------------------------------------------------------------------------------------------------------
...
qiime taxa collapse   \
                              ...
                              --i-taxonomy taxonomy.qza  \
                              --p-level 4  \
                              --o-collapsed-table gut-table-l4.qza



qiime composition add-pseudocount    \
                              --i-table gut-table-l4.qza   \
                              --o-composition-table comp-gut-table-l4.qza


qiime composition ancom   \
                              --i-table comp-gut-table-l4.qza   \
                              --m-metadata-file sample-metadata.tsv  \
                              --m-metadata-column Description   \
                              --o-visualization l4-ancom-Subject.qzv
...
qiime feature-table filter-samples \
                          --i-table table.qza \
                          --m-metadata-file  ../sample-metadata.tsv  \
                          --p-where   "Description IN ('WT','KO')" \
                          --o-filtered-table filter_table.qza


qiime feature-table summarize \
                                    --i-table filter_table.qza \
                                    --o-visualization filter_table.qzv \
                                    --m-sample-metadata-file filter_sample-metadata.tsv
